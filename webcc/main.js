...
//${CONFIG_BEGIN}
CFG_AUTOSTREAM_IMPLEMENTED="1";
CFG_AUTOSTREAM_USE_BUFFERS_DIRECTLY="1";
CFG_BINARY_FILES="*.bin|*.dat";
CFG_BOXUTIL_IMPLEMENTED="1";
CFG_BOXUTIL_SHARED_CONVERSION="1";
CFG_BOXUTIL_STANDARD_UNBOXING="0";
CFG_BRL_DATABUFFER_IMPLEMENTED="1";
CFG_BRL_OS_IMPLEMENTED="1";
CFG_BRL_STREAM_IMPLEMENTED="1";
CFG_BRL_THREAD_IMPLEMENTED="1";
CFG_BYTEORDER_CACHE="1";
CFG_BYTEORDER_FLOATING_POINT="1";
CFG_CD="";
CFG_CONFIG="release";
CFG_DEBUG_PRINT="0";
CFG_DEBUG_PRINT_ON_ERROR="1";
CFG_DEBUG_PRINT_QUOTES="0";
CFG_FLAG_CLEAR_LISTS="1";
CFG_FLAG_CONSOLE="0";
CFG_FLAG_CONSOLEMODE="0";
CFG_FLAG_DESKTOP="0";
CFG_FLAG_FULLSCREEN_AUTO="0";
CFG_FLAG_MOBILE="0";
CFG_FLAG_MULTIPLAYER="0";
CFG_GOODLOOKINGUY_IMPLEMENTED="1";
CFG_HOST="winnt";
CFG_IMAGE_FILES="*.png|*.jpg";
CFG_IOELEMENT_IMPLEMENTED="1";
CFG_LANG="js";
CFG_LOAD_IMG_DIMENSIONS="1";
CFG_LOAD_IMG_DIMENSIONS_CHECKEXT="0";
CFG_LOAD_IMG_DIMENSIONS_PATHS="1";
CFG_MODPATH="";
CFG_MOJO_EMULATOR_APP_IMPLEMENTED="1";
CFG_MOJO_EMULATOR_ASYNCLOADERS_IMPLEMENTED="1";
CFG_MOJO_EMULATOR_AUTOEXIT="1";
CFG_MOJO_EMULATOR_CPP_GC_MODE_CALLBACKS="1";
CFG_MOJO_EMULATOR_FORCE_ALTERNATIVE="0";
CFG_MOJO_EMULATOR_FORCE_MOJO="0";
CFG_MOJO_EMULATOR_IMPLEMENTED="1";
CFG_MOJO_EMULATOR_STANDARD_UPDATE_RATE="1";
CFG_MONKEYLANG_EXTENSION_UNSIGNED_TYPES="0";
CFG_MONKEYLANG_EXTENSION_WIDECHARACTERS="1";
CFG_MUSIC_FILES="*.wav|*.ogg|*.mp3|*.m4a";
CFG_RETROSTRINGSEXTENSION_DECBE="1";
CFG_RETROSTRINGSEXTENSION_DECLE="1";
CFG_RETROSTRINGSEXTENSION_HEXBE="1";
CFG_RETROSTRINGSEXTENSION_HEXLE="1";
CFG_RETROSTRINGS_AUTHENTIC="0";
CFG_RETROSTRINGS_EXTENSION_IMPLEMENTED="1";
CFG_RETROSTRINGS_IMPLEMENTED="1";
CFG_RETROSTRINGS_REPORT_ERRORS="1";
CFG_RETROSTRINGS_SAFE="1";
CFG_RETROSTRINGS_STRICT="1";
CFG_SAFEMODE="0";
CFG_SIZEOF_DATABUFFER="1";
CFG_SIZEOF_IMPLEMENTED="1";
CFG_SOUND_FILES="*.wav|*.ogg|*.mp3|*.m4a";
CFG_STRINGUTIL_ALTERNATE_FLOAT_SHORTEN="0";
CFG_STRINGUTIL_IMPLEMENTED="1";
CFG_STRINGUTIL_IMPORT_RETROSTRINGS="1";
CFG_STRINGUTIL_MAXIMIZE_COMPATIBILITY="1";
CFG_STRINGUTIL_PREFER_ENUMERATORS="1";
CFG_STRINGUTIL_SAFE="1";
CFG_STRING_UTIL_IMPLEMENTED="1";
CFG_TARGET="html5";
CFG_TEXT_FILES="*.monkey|*.MONKEY|*.TXT|*.js|*.dir|*.html|*.ico;*.txt|*.xml|*.json";
CFG_TIME_MOJO_IMPLEMENTED="0";
CFG_TIME_WRAP_MOJO="1";
CFG_TYPETOOL_IMPLEMENTED="1";
CFG_TYPETOOL_IMPORT_UTIL="1";
CFG_TYPETOOL_SIMULATE_PROPER_BOUNDS="1";
CFG_TYPETOOL_SIMULATE_PROPER_BOUNDS_ROLLOVER="1";
CFG_TYPETOOL_SIMULATE_SIGNED_TYPES="1";
CFG_TYPETOOL_SIMULATE_SIGNED_TYPES_AS_UNSIGNED="0";
CFG_UTIL_IMPLEMENTED="1";
CFG_UTIL_SUPPORT_IOELEMENTS="1";
CFG_UTIL_TEMP_BUFFERS="1";
CFG_UTIL_WRAP_BOTH_WAYS="1";
CFG_VECTOR_ALLOW_EXACT_GROWTH="1";
CFG_VECTOR_ALLOW_SERIALIZATION="1";
CFG_VECTOR_ALTERNATE_DIVISION="1";
CFG_VECTOR_ALTERNATE_NEGATE="0";
CFG_VECTOR_CONSTANT_NAME_STRINGS="1";
CFG_VECTOR_GROW_ON_ACCESS="1";
CFG_VECTOR_IMPLEMENTED="1";
CFG_VECTOR_LEGACY_NAME_STRINGS="0";
CFG_VECTOR_NUMBER_SAFETY="0";
CFG_VECTOR_SAFETY="1";
CFG_VECTOR_SHARE_OPTIMIZATIONS="1";
CFG_VECTOR_SMART_GROW="1";
CFG_VECTOR_SUPPORTLAYER_TYPEFIXES="0";
CFG_VECTOR_SUPPORT_IOELEMENT="1";
CFG_VECTOR_SUPPORT_SIZEOF="1";
CFG_VECTOR_TOSTRING_USE_GENERIC_UTIL="0";
CFG_VECTOR_TYPEFIXES="0";
CFG_VECTOR_ZERO_WITH_NIL="1";
...
CFG_VIRTUALOS_MAP_FILETIMES="1";
//${CONFIG_END}

//${METADATA_BEGIN}
var META_DATA="[bananas/Richard_Betson/TileImage/TileImage.buildv85a/html5/data/bg.png];type=image/png;width=128;height=128;\n[bananas/Richard_Betson/TileImage/TileImage.buildv85a/html5/data/mojo2_font.png];type=image/png;width=960;height=16;\n[bananas/Richard_Betson/TileImage/TileImage.buildv85a/html5/data/mojo_font.png];type=image/png;width=864;height=13;\n[bananas/Richard_Betson/TileImage/TileImage.buildv85e/glfw3/gcc_winnt/Debug/data/bg.png];type=image/png;width=128;height=128;\n[bananas/Richard_Betson/TileImage/TileImage.buildv85e/glfw3/gcc_winnt/Debug/data/mojo_font.png];type=image/png;width=864;height=13;\n[bananas/Richard_Betson/TileImage/TileImage.buildv85e/html5/data/bg.png];type=image/png;width=128;height=128;\n[bananas/Richard_Betson/TileImage/TileImage.buildv85e/html5/data/mojo_font.png];type=image/png;width=864;height=13;\n[bananas/Richard_Betson/TileImage/TileImage.data/bg.png];type=image/png;width=128;height=128;\n[bananas/Richard_Betson/glfw_diffusion/glfw_diffusion_example.buildv85a/glfw3/gcc_winnt/Release/data/mojo2_font.png];type=image/png;width=960;height=16;\n[bananas/Richard_Betson/glfw_diffusion/glfw_diffusion_example.buildv85a/glfw3/gcc_winnt/Release/data/mojo_font.png];type=image/png;width=864;height=13;\n[bananas/Richard_Betson/line_v_circle_collision/line_v_circle_collision.data/circle2f.png];type=image/png;width=16;height=16;\n[bananas/Richard_Betson/mirror_fx_transform/mirror_fx_transform.data/c.png];type=image/png;width=16;height=16;\n[bananas/beaker/angelfont_example/angelfont_example.data/angel3.png];type=image/png;width=256;height=256;\n[bananas/beaker/angelfont_example/angelfont_example.data/angel_verdana.png];type=image/png;width=256;height=256;\n[bananas/beaker/angelfont_example/angelfont_example.data/angel_verdana_0.png];type=image/png;width=256;height=256;\n[bananas/beaker/angelfont_example/angelfont_example.data/pagedfont_0.png];type=image/png;width=128;height=128;\n[bananas/beaker/angelfont_example/angelfont_example.data/pagedfont_1.png];type=image/png;width=128;height=128;\n[bananas/charlie/blobmonster/blobmonster.data/blob.png];type=image/png;width=50;height=48;\n[bananas/devolonter/matchup/matchup.data/fonts/main_P_1.png];type=image/png;width=512;height=512;\n[bananas/devolonter/matchup/matchup.data/fonts/main_P_2.png];type=image/png;width=512;height=512;\n[bananas/devolonter/matchup/matchup.data/images/bg.png];type=image/png;width=640;height=480;\n[bananas/devolonter/matchup/matchup.data/images/cards/1.png];type=image/png;width=100;height=100;\n[bananas/devolonter/matchup/matchup.data/images/cards/2.png];type=image/png;width=100;height=100;\n[bananas/devolonter/matchup/matchup.data/images/cards/3.png];type=image/png;width=100;height=100;\n[bananas/devolonter/matchup/matchup.data/images/cards/4.png];type=image/png;width=100;height=100;\n[bananas/devolonter/matchup/matchup.data/images/cards/5.png];type=image/png;width=100;height=100;\n[bananas/devolonter/matchup/matchup.data/images/cards/6.png];type=image/png;width=100;height=100;\n[bananas/devolonter/matchup/matchup.data/images/cards/bg.png];type=image/png;width=100;height=100;\n[bananas/ferdi/breakout/breakout.buildv85e/glfw3/gcc_winnt/Debug/data/mojo_font.png];type=image/png;width=864;height=13;\n[bananas/gerryq/picpuzzle/picpuzzle.data/pic000.jpg];type=image/jpg;width=512;height=512;\n[bananas/gerryq/picpuzzle/picpuzzle.data/pic001.jpg];type=image/jpg;width=512;height=512;\n[bananas/gerryq/picpuzzle/picpuzzle.data/pic002.jpg];type=image/jpg;width=512;height=512;\n[bananas/gerryq/picpuzzle/picpuzzle.data/rightbar.png];type=image/png;width=256;height=512;\n[bananas/hitoro/autofit/simpledemo.buildv85a/glfw3/gcc_winnt/Debug/data/mojo_font.png];type=image/png;width=864;height=13;\n[bananas/hitoro/autofit/simpledemo.buildv85a/glfw3/gcc_winnt/Release/data/mojo2_font.png];type=image/png;width=960;height=16;\n[bananas/hitoro/autofit/simpledemo.buildv85a/glfw3/gcc_winnt/Release/data/mojo_font.png];type=image/png;width=864;height=13;\n[bananas/hitoro/basicgame/basicgame.data/player.png];type=image/png;width=256;height=256;\n[bananas/hitoro/gamestates_demo/gamestates_demo.data/menu.png];type=image/png;width=116;height=9;\n[bananas/hitoro/gamestates_demo/gamestates_demo.data/player.png];type=image/png;width=256;height=256;\n[bananas/hitoro/jump_rotate/jump_rotate.data/block.png];type=image/png;width=256;height=128;\n[bananas/hitoro/jump_rotate/jump_rotate.data/player.png];type=image/png;width=256;height=256;\n[bananas/hitoro/matrixrocks/matrixrocks.data/default_player.png];type=image/png;width=256;height=256;\n[bananas/hitoro/rockout/rockout.data/defaultgfx/blue.png];type=image/png;width=48;height=24;\n[bananas/hitoro/rockout/rockout.data/defaultgfx/default_player.png];type=image/png;width=64;height=64;\n[bananas/hitoro/rockout/rockout.data/defaultgfx/default_shot.png];type=image/png;width=8;height=8;\n[bananas/hitoro/rotationsickness/rotationsickness.data/block.png];type=image/png;width=256;height=128;\n[bananas/hitoro/rotationsickness/rotationsickness.data/player.png];type=image/png;width=256;height=256;\n[bananas/impixi/life/life.buildv85e/glfw3/gcc_winnt/Debug/data/mojo2_font.png];type=image/png;width=960;height=16;\n[bananas/impixi/life/life.buildv85e/glfw3/gcc_winnt/Debug/data/mojo_font.png];type=image/png;width=864;height=13;\n[bananas/impixi/life/life.buildv85e/glfw3/gcc_winnt/Release/data/mojo2_font.png];type=image/png;width=960;height=16;\n[bananas/impixi/life/life.buildv85e/glfw3/gcc_winnt/Release/data/mojo_font.png];type=image/png;width=864;height=13;\n[bananas/mak/bouncyaliens/bouncyaliens.data/alien1.png];type=image/png;width=128;height=16;\n[bananas/mak/bouncyaliens/bouncyaliens.data/alien2.png];type=image/png;width=128;height=16;\n[bananas/mak/firepaint/firepaint.buildv85e/Release/data/bluspark.png];type=image/png;width=64;height=64;\n[bananas/mak/firepaint/firepaint.buildv85e/Release/data/mojo_font.png];type=image/png;width=864;height=13;\n[bananas/mak/firepaint/firepaint.buildv85e/glfw3/gcc_winnt/Debug/data/bluspark.png];type=image/png;width=64;height=64;\n[bananas/mak/firepaint/firepaint.buildv85e/glfw3/gcc_winnt/Debug/data/mojo2_font.png];type=image/png;width=960;height=16;\n[bananas/mak/firepaint/firepaint.buildv85e/glfw3/gcc_winnt/Debug/data/mojo_font.png];type=image/png;width=864;height=13;\n[bananas/mak/firepaint/firepaint.data/bluspark.png];type=image/png;width=64;height=64;\n[bananas/mak/firepaint/mojoinmojo2/Examples/Mojo_In_Mojo2_Test/Mojo_In_Mojo2_Test.buildv85e/glfw3/gcc_winnt/Debug/data/Test.png];type=image/png;width=64;height=64;\n[bananas/mak/firepaint/mojoinmojo2/Examples/Mojo_In_Mojo2_Test/Mojo_In_Mojo2_Test.buildv85e/glfw3/gcc_winnt/Debug/data/mojo2_font.png];type=image/png;width=960;height=16;\n[bananas/mak/firepaint/mojoinmojo2/Examples/Mojo_In_Mojo2_Test/Mojo_In_Mojo2_Test.buildv85e/glfw3/gcc_winnt/Debug/data/mojo_font.png];type=image/png;width=864;height=13;\n[bananas/mak/firepaint/mojoinmojo2/Examples/Mojo_In_Mojo2_Test/Mojo_In_Mojo2_Test.buildv85e/glfw3/gcc_winnt/Release/data/Test.png];type=image/png;width=64;height=64;\n[bananas/mak/firepaint/mojoinmojo2/Examples/Mojo_In_Mojo2_Test/Mojo_In_Mojo2_Test.buildv85e/glfw3/gcc_winnt/Release/data/mojo2_font.png];type=image/png;width=960;height=16;\n[bananas/mak/firepaint/mojoinmojo2/Examples/Mojo_In_Mojo2_Test/Mojo_In_Mojo2_Test.buildv85e/glfw3/gcc_winnt/Release/data/mojo_font.png];type=image/png;width=864;height=13;\n[bananas/mak/firepaint/mojoinmojo2/Examples/Mojo_In_Mojo2_Test/Mojo_In_Mojo2_Test.data/Test.png];type=image/png;width=64;height=64;\n[bananas/mak/gles20cube/gles20cube.data/mandril.jpg];type=image/jpg;width=256;height=256;\n[bananas/mak/joytest/joytest.buildv85a/glfw3/gcc_winnt/Debug/data/mojo_font.png];type=image/png;width=864;height=13;\n[bananas/mak/joytest/joytest.buildv85a/glfw3/gcc_winnt/Release/data/mojo_font.png];type=image/png;width=864;height=13;\n[bananas/mak/joytest/joytest.buildv85a/xna/MonkeyGame/MonkeyGame/Background.png];type=image/png;width=173;height=173;\n[bananas/mak/joytest/joytest.buildv85a/xna/MonkeyGame/MonkeyGame/GameThumbnail.png];type=image/png;width=64;height=64;\n[bananas/mak/joytest/joytest.buildv85a/xna/MonkeyGame/MonkeyGameContent/monkey/mojo_font.png];type=image/png;width=864;height=13;\n[bananas/mak/mojotest/mojotest.data/images/RedbrushAlpha.png];type=image/png;width=256;height=240;\n[bananas/mak/opengltest/opengltest.data/Grass_1.png];type=image/png;width=256;height=256;\n[bananas/mak/unicodetest/unicodetest.buildv85a/glfw3/gcc_winnt/Release/data/mojo_font.png];type=image/png;width=864;height=13;\n[bananas/mak/unicodetest/unicodetest.buildv85a/glfw3_angle/gcc_winnt/Release/data/mojo_font.png];type=image/png;width=864;height=13;\n[bananas/origaming/DegreeAndRadian/DegreeAndRadian.data/DegreeAndRadian.png];type=image/png;width=125;height=79;\n[bananas/origaming/FollowMouse/FollowMouse.buildv85a/glfw3/gcc_winnt/Debug/data/FollowMouse.png];type=image/png;width=43;height=43;\n[bananas/origaming/FollowMouse/FollowMouse.buildv85a/glfw3/gcc_winnt/Debug/data/mojo2_font.png];type=image/png;width=960;height=16;\n[bananas/origaming/FollowMouse/FollowMouse.buildv85a/glfw3/gcc_winnt/Debug/data/mojo_font.png];type=image/png;width=864;height=13;\n[bananas/origaming/FollowMouse/FollowMouse.data/FollowMouse.png];type=image/png;width=43;height=43;\n[bananas/origaming/MacOsMenu/MacOsMenu.data/MacOsMenu.png];type=image/png;width=43;height=43;\n[bananas/origaming/RotatingObjects/rotatingObjects.data/bullet.png];type=image/png;width=50;height=41;\n[bananas/origaming/RotatingObjects/rotatingObjects.data/rotatingObjects.png];type=image/png;width=71;height=35;\n[bananas/skn3/iconfun/iconfun.data/font_black.png];type=image/png;width=864;height=13;\n[bananas/skn3/iconfun/iconfun.data/font_white.png];type=image/png;width=864;height=13;\n[bananas/skn3/iconfun/iconfun.data/loading.png];type=image/png;width=96;height=16;\n[bananas/skn3/monkenstein/monkenstein.data/textures.png];type=image/png;width=512;height=256;\n[bananas/skn3/texteffect/texteffect.buildv85a/glfw3/gcc_winnt/Release/data/font.png];type=image/png;width=512;height=512;\n[bananas/skn3/texteffect/texteffect.buildv85a/glfw3/gcc_winnt/Release/data/mojo_font.png];type=image/png;width=864;height=13;\n[bananas/skn3/texteffect/texteffect.data/font.png];type=image/png;width=512;height=512;\n[bananas/warpy/horsey/horsey.data/bg.png];type=image/png;width=600;height=650;\n[bananas/warpy/horsey/horsey.data/fg.png];type=image/png;width=600;height=650;\n[bananas/warpy/horsey/horsey.data/horse.png];type=image/png;width=200;height=165;\n[bananas/warpy/monkeypuzzle/monkeypuzzle.data/monkey.png];type=image/png;width=512;height=512;\n[bg.png];type=image/png;width=128;height=128;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleAnalytics/Examples/CuteAnimals/Images/Bunny-1.jpg];type=image/jpg;width=480;height=360;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleAnalytics/Examples/CuteAnimals/Images/Bunny-2.jpg];type=image/jpg;width=480;height=322;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleAnalytics/Examples/CuteAnimals/Images/Bunny-3.jpg];type=image/jpg;width=480;height=381;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleAnalytics/Examples/CuteAnimals/Images/Cat-1.jpg];type=image/jpg;width=480;height=345;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleAnalytics/Examples/CuteAnimals/Images/Cat-2.jpg];type=image/jpg;width=480;height=360;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleAnalytics/Examples/CuteAnimals/Images/Cat-3.jpg];type=image/jpg;width=480;height=360;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleAnalytics/Examples/CuteAnimals/Images/Cat-4.jpg];type=image/jpg;width=480;height=343;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleAnalytics/Examples/CuteAnimals/Images/Lion-1.jpg];type=image/jpg;width=480;height=319;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleAnalytics/Examples/CuteAnimals/Images/Lion-2.jpg];type=image/jpg;width=480;height=322;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleAnalytics/Examples/CuteAnimals/Images/Lion-3.jpg];type=image/jpg;width=480;height=322;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleAnalytics/Examples/CuteAnimals/Images/Lion-4.jpg];type=image/jpg;width=480;height=318;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleAnalytics/Examples/CuteAnimals/Images/Monkey-1.jpg];type=image/jpg;width=480;height=320;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleAnalytics/Examples/CuteAnimals/Images/Monkey-2.jpg];type=image/jpg;width=480;height=324;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleAnalytics/Examples/CuteAnimals/Images/Monkey-3.jpg];type=image/jpg;width=480;height=360;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleAnalytics/Examples/CuteAnimals/Images/Monkey-4.jpg];type=image/jpg;width=480;height=360;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleAnalytics/Examples/CuteAnimals/Images/Monkey-5.jpg];type=image/jpg;width=480;height=360;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleAnalytics/Examples/CuteAnimals/Images/Tiger-1.jpg];type=image/jpg;width=480;height=321;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleAnalytics/Examples/CuteAnimals/Images/Tiger-2.jpg];type=image/jpg;width=480;height=320;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/Bunny-1.jpg];type=image/jpg;width=480;height=360;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/Bunny-2.jpg];type=image/jpg;width=480;height=322;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/Bunny-3.jpg];type=image/jpg;width=480;height=381;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/Cat-1.jpg];type=image/jpg;width=480;height=345;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/Cat-2.jpg];type=image/jpg;width=480;height=360;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/Cat-3.jpg];type=image/jpg;width=480;height=360;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/Cat-4.jpg];type=image/jpg;width=480;height=343;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/Container.png];type=image/png;width=1291;height=942;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/CustomTag.png];type=image/png;width=1209;height=701;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/Lion-1.jpg];type=image/jpg;width=480;height=319;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/Lion-2.jpg];type=image/jpg;width=480;height=322;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/Lion-3.jpg];type=image/jpg;width=480;height=322;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/Lion-4.jpg];type=image/jpg;width=480;height=318;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/Monkey-1.jpg];type=image/jpg;width=480;height=320;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/Monkey-2.jpg];type=image/jpg;width=480;height=324;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/Monkey-3.jpg];type=image/jpg;width=480;height=360;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/Monkey-4.jpg];type=image/jpg;width=480;height=360;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/Monkey-5.jpg];type=image/jpg;width=480;height=360;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/NumRefreshesMod5.png];type=image/png;width=1213;height=497;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/RefreshEvent.png];type=image/png;width=1208;height=518;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/RefreshEventTag.png];type=image/png;width=1538;height=1306;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/ScreenClosedTag.png];type=image/png;width=1531;height=1308;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/ScreenOpenTag.png];type=image/png;width=1539;height=1102;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/Tiger-1.jpg];type=image/jpg;width=480;height=321;\n[modules/brl/native/GoogleAdMobAdsSdkiOS-6.8.0/Add-ons/GoogleAnalyticsServicesiOS_3.03/GoogleTagManager/Examples/CuteAnimals/Images/Tiger-2.jpg];type=image/jpg;width=480;height=320;\n[modules/mojo/data/mojo_font.png];type=image/png;width=864;height=13;\n";
//${METADATA_END}
...
function c_TransCC(){
	...
	this.m_HTML_PLAYER="";
	this.m_FLASH_PLAYER="";
	this.m__builders=c_StringMap4.m_new.call(new c_StringMap4);
	this.m__targets=c_StringMap7.m_new.call(new c_StringMap7);
	this.m_target=null;
}
c_TransCC.m_new=function(){
	return this;
}
c_TransCC.prototype.p_ParseArgs=function(){
	if(this.m_args.length>1){
		this.m_opt_srcpath=bb_transcc_StripQuotes(string_trim(this.m_args[this.m_args.length-1]));
	}
		...
		if(t_j==-1){
						...
						if(t_1=="-update"){
							...
							if(t_1=="-build"){
								...
								if(t_1=="-run"){
									...
									bb_transcc_Die("Unrecognized command line option: "+t_arg);
								}
							}
						}
					}
			...
			if(string_startswith(t_arg,"-")){
				...
				if(string_startswith(t_arg,"+")){
					...
					bb_transcc_Die("Command line arg error: "+t_arg);
				}
			}
		}
	}
}
c_TransCC.prototype.p_LoadConfig=function(){
	...
	if(FileType(t_cfgpath)!=1){
		bb_transcc_Die("Failed to open config file");
	}
...
c_TransCC.prototype.p_EnumBuilders=function(){
	var t_=bb_builders_Builders(this).p_ObjectEnumerator();
	while(t_.p_HasNext()){
		var t_it=t_.p_NextObject();
		if(t_it.p_Value().p_IsValid()){
			this.m__builders.p_Set4(t_it.p_Key(),t_it.p_Value());
		}
	}
}
c_TransCC.prototype.p_EnumTargets=function(t_dir){
			...
			if((t_system).length!=0){
				...
				if((t_builder)!=null){
					...
					if(!((t_host).length!=0) || t_host==HostOS()){
						this.m__targets.p_Set7(t_name,c_Target.m_new.call(new c_Target,t_f,t_name,t_system,t_builder));
					}
				}
			}
		}
...
c_TransCC.prototype.p_GetReleaseVersion=function(){
...
c_TransCC.prototype.p_Run=function(t_args){
	this.m_args=t_args;
	...
	if(!((this.m_target)!=null)){
		bb_transcc_Die("Invalid target");
	}
	this.m_target.m_builder.p_Make();
}
c_TransCC.prototype.p_Execute=function(t_cmd,t_failHard){
	var t_r=Execute(t_cmd);
	if(!((t_r)!=0)){
		return true;
	}
	if(t_failHard){
		bb_transcc_Die("Error executing '"+t_cmd+"', return code="+String(t_r));
	}
	return false;
}
function c_Stream(){
...
c_Stream.prototype.p_Write=function(t_buffer,t_offset,t_count){
}
c_Stream.prototype.p_WriteError=function(){
	throw c_StreamWriteError.m_new.call(new c_StreamWriteError,this);
}
c_Stream.prototype.p_WriteAll=function(t_buffer,t_offset,t_count){
	while(t_count>0){
		var t_n=this.p_Write(t_buffer,t_offset,t_count);
		if(t_n<=0){
			this.p_WriteError();
		}
		t_offset+=t_n;
...
c_Stream.prototype.p_WriteString=function(t_value,t_encoding){
	var t_buf=c_DataBuffer.m_new.call(new c_DataBuffer,t_value.length*3,false);
	var t_len=t_buf.p_PokeString(0,t_value,"utf8");
	this.p_WriteAll(t_buf,0,t_len);
}
...
c_Stream.prototype.p_ReadAll2=function(){
	var t_bufs=c_Stack3.m_new.call(new c_Stack3);
...
c_Stream.prototype.p_ReadLine=function(){
	var t_buf=c_Stack4.m_new.call(new c_Stack4);
	while(!((this.p_Eof())!=0)){
...
function c_PublicDataStream(){
	c_Stream.call(this);
	this.m__Data=null;
	this.m__RawSize=0;
	this.m_BigEndianStorage=false;
	this.m_ShouldResize=false;
	this.m_SizeLimit=0;
	this.m_OwnsBuffer=false;
	this.m_Offset=0;
	this.m__Length=0;
	this.m__Position=0;
	this.m_ResizeScalar=1.5;
	this.implments={c_IOnLoadDataComplete:1};
}
c_PublicDataStream.prototype=extend_class(c_Stream);
c_PublicDataStream.prototype.p_Data=function(){
	return this.m__Data;
}
c_PublicDataStream.prototype.p_Data2=function(t_Input){
	this.m__Data=t_Input;
	return;
}
c_PublicDataStream.prototype.p_RawSize=function(){
	return this.m__RawSize;
}
c_PublicDataStream.prototype.p_RawSize2=function(t_Input){
	this.m__RawSize=t_Input;
	return;
}
c_PublicDataStream.prototype.p_GenerateBuffer=function(t_Size){
	this.p_Data2(c_DataBuffer.m_new.call(new c_DataBuffer,t_Size,false));
	this.p_RawSize2(t_Size);
	return;
}
c_PublicDataStream.prototype.p_GenerateBuffer2=function(t_B){
	this.p_GenerateBuffer(t_B.Length());
	t_B.p_CopyBytes(0,this.p_Data(),0,this.p_Data().Length());
	return;
}
c_PublicDataStream.m_new=function(t_Size,t_BigEndianStorage,t_Resizable,t_SizeLimit){
	c_Stream.m_new.call(this);
	this.p_GenerateBuffer(t_Size);
	this.m_BigEndianStorage=t_BigEndianStorage;
	this.m_ShouldResize=t_Resizable;
	this.m_SizeLimit=t_SizeLimit;
	return this;
}
c_PublicDataStream.m_new2=function(t_B,t_Length,t_Offset,t_Copy,t_BigEndianStorage,t_Resizable,t_SizeLimit){
	c_Stream.m_new.call(this);
	if(t_Copy){
		this.p_GenerateBuffer2(t_B);
		this.m_OwnsBuffer=true;
	}else{
		this.p_Data2(t_B);
	}
	this.m_Offset=t_Offset;
	this.m__Length=t_Length;
	this.p_RawSize2(t_Length);
	this.m_BigEndianStorage=t_BigEndianStorage;
	this.m_ShouldResize=t_Resizable;
	this.m_SizeLimit=t_SizeLimit;
	return this;
}
c_PublicDataStream.prototype.p_OnLoadDataComplete=function(t_Data,t_Path){
	if(this.p_Data()==null){
		this.p_Data2(t_Data);
		this.m__Length=t_Data.Length();
	}
	return;
}
c_PublicDataStream.m_new3=function(t_Path,t_BigEndianStorage,t_Async){
	c_Stream.m_new.call(this);
	if(!t_Async){
		this.p_OnLoadDataComplete(c_DataBuffer.m_Load(t_Path),t_Path);
	}else{
		c_DataBuffer.m_LoadAsync(t_Path,(this));
	}
	this.m_BigEndianStorage=t_BigEndianStorage;
	return this;
}
c_PublicDataStream.m_new4=function(){
	c_Stream.m_new.call(this);
	return this;
}
c_PublicDataStream.prototype.p_DataLength=function(){
	return this.p_RawSize()-this.m_Offset;
}
c_PublicDataStream.prototype.p_Seek=function(t_Input){
	this.m__Position=bb_math_Clamp(t_Input,0,this.p_DataLength());
	return this.m__Position;
}
c_PublicDataStream.prototype.p_Position=function(){
	return this.m__Position;
}
c_PublicDataStream.prototype.p_Length=function(){
	return this.m__Length;
}
c_PublicDataStream.prototype.p_ReadWillOverReach=function(t_Bytes){
	return this.p_Position()+t_Bytes>this.p_Length();
}
c_PublicDataStream.prototype.p_WillOverReach=function(t_Bytes){
	return this.p_ReadWillOverReach(t_Bytes);
}
c_PublicDataStream.prototype.p_BytesLeft=function(){
	return bb_math_Max(this.p_Length()-this.p_Position(),0);
}
c_PublicDataStream.prototype.p_DataOffset=function(){
	return this.m_Offset+this.p_Position();
}
c_PublicDataStream.prototype.p_Read=function(t_Buf,t_Offset,t_Count){
	if(this.p_WillOverReach(t_Count)){
		t_Count=this.p_BytesLeft();
	}
	this.p_Data().p_CopyBytes(this.p_DataOffset(),t_Buf,t_Offset,t_Count);
	this.m__Position+=t_Count;
	return t_Count;
}
c_PublicDataStream.prototype.p_Resize=function(t_NewSize,t_Force){
	if(!this.m_OwnsBuffer){
		return false;
	}
	if(this.m_SizeLimit!=0){
		if(t_NewSize>this.m_SizeLimit){
			if(t_Force){
				t_NewSize=bb_math_Min(t_NewSize,this.m_SizeLimit);
			}else{
				return false;
			}
		}
	}
	this.p_Data2(bb_util_ResizeBuffer(this.p_Data(),t_NewSize,true,true,true));
	return this.p_Data()!=null;
}
c_PublicDataStream.prototype.p_AutoResize=function(t_MinBytes){
	if(!this.m_OwnsBuffer){
		return false;
	}
	return this.p_Resize(bb_math_Max((((this.p_Data().Length())*this.m_ResizeScalar)|0),t_MinBytes),false);
}
c_PublicDataStream.prototype.p_SetLength=function(t_Value){
	this.m__Length=bb_math_Min(t_Value,this.p_DataLength());
	return;
}
c_PublicDataStream.prototype.p_SetLengthSafe=function(t_Value){
	this.p_SetLength(bb_math_Max(t_Value,this.m__Length));
	return;
}
c_PublicDataStream.prototype.p_Write=function(t_Buf,t_Offset,t_Count){
	var t_NewPosition=t_Count+this.p_Position();
	if(t_NewPosition>this.p_DataLength()){
		if(this.m_ShouldResize){
			this.p_AutoResize(t_Count);
		}else{
			t_Count=this.p_DataLength()-this.p_Position();
		}
	}
	t_Buf.p_CopyBytes(t_Offset,this.p_Data(),this.p_DataOffset(),t_Count);
	this.m__Position=t_NewPosition;
	this.p_SetLengthSafe(t_NewPosition);
	return t_Count;
}
c_PublicDataStream.prototype.p_Eof=function(){
	return ((this.p_Position()>=this.p_Length())?1:0);
}
c_PublicDataStream.prototype.p_FreeBuffer=function(t_DiscardBuffer){
	if(this.p_Data()!=null){
		if(t_DiscardBuffer){
			this.p_Data().Discard();
		}
...
c_PublicDataStream.prototype.p_Close=function(){
	this.p_FreeBuffer(this.m_OwnsBuffer);
	this.m_Offset=0;
	this.m__Position=0;
	return;
}
function c_StringStream(){
	c_PublicDataStream.call(this);
	this.implments={c_IOnLoadDataComplete:1};
}
c_StringStream.prototype=extend_class(c_PublicDataStream);
c_StringStream.m_Default_Size=0;
c_StringStream.m_new=function(t_Message,t_Encoding,t_FixByteOrder,t_InitSize,t_SizeLimit,t_SeekBack){
	c_PublicDataStream.m_new.call(this,bb_math_Max(t_InitSize,t_Message.length*1),t_FixByteOrder,true,t_SizeLimit);
	this.p_WriteString(t_Message,t_Encoding);
	if(t_SeekBack){
		this.p_Seek(0);
	}
	return this;
}
c_StringStream.m_new2=function(t_Size,t_FixByteOrder,t_SizeLimit){
	c_PublicDataStream.m_new.call(this,t_Size,t_FixByteOrder,true,t_SizeLimit);
	return this;
}
...
c_DataBuffer.m_LoadAsync=function(t_path,t_onComplete){
	var t_data=c_DataBuffer.m_new2.call(new c_DataBuffer);
	var t_loader=c_AsyncDataLoader.m_new.call(new c_AsyncDataLoader,t_data,t_path,t_onComplete);
	t_loader.Start();
}
...
c_Thread.prototype=extend_class(BBThread);
c_Thread.m_new=function(){
	return this;
}
c_Thread.m_Strdup=function(t_str){
	return t_str;
}
function c_AsyncDataLoader(){
	c_Thread.call(this);
	this.m__data=null;
	this.m__path="";
...
c_AsyncDataLoader.prototype=extend_class(c_Thread);
c_AsyncDataLoader.m_new=function(t_data,t_path,t_onComplete){
	c_Thread.m_new.call(this);
	this.m__data=t_data;
	this.m__path=t_path;
	this.m__onComplete=t_onComplete;
	return this;
}
c_AsyncDataLoader.m_new2=function(){
	c_Thread.m_new.call(this);
	return this;
}
c_AsyncDataLoader.prototype.Start=function(){
	bb_asyncevent_AddAsyncEventSource(this);
	BBThread.prototype.Start.call(this);
}
c_AsyncDataLoader.prototype.Run__UNSAFE__=function(){
...
function c_StreamWriteError(){
	c_StreamError.call(this);
}
c_StreamWriteError.prototype=extend_class(c_StreamError);
c_StreamWriteError.m_new=function(t_stream){
	c_StreamError.m_new.call(this,t_stream);
	return this;
}
c_StreamWriteError.m_new2=function(){
...
c_Stack2.prototype.p_Clear=function(){
	for(var t_i=0;t_i<this.m_length;t_i=t_i+1){
		this.m_data[t_i]=c_Stack2.m_NIL;
	}
	this.m_length=0;
...
function bb_stringutil_SmartClip(t_Input,t_Symbol,t_Length){
...
function bb_stringutil_SmartClip2(t_Input,t_Symbol){
	return bb_stringutil_SmartClip(t_Input,t_Symbol,t_Input.length);
}
function c_Map(){
	Object.call(this);
	this.m_root=null;
...
c_Map.prototype.p_Contains2=function(t_key){
...
var bb_virtualos___OS_FileTimes=null;
function c_Node(){
	Object.call(this);
	this.m_key="";
	this.m_right=null;
...
function bb_virtualos___OS_SetFileTime(t_RealPath,t_Time){
	bb_virtualos___OS_FileTimes.p_Set(t_RealPath,t_Time);
	return;
}
	...
	while(!((t_S.p_Eof())!=0)){
		...
		if(t_5=="\n" || t_5=="\r" || t_5=="\t" || t_5==" "){
			...
			if(t_5=="!"){
				...
				if(t_5=="{"){
					t_Context.p_Push4(t_LastMasterPath);
		...
		for(var t_I=0;t_I<t_Entries.length;t_I=t_I+1){
			...
			t_E=t_Cache_Context+bb_stringutil_SmartClip(t_E,32,t_E_Length);
			var t_Time_First=t_E.indexOf("[",0);
			if(t_Time_First!=-1){
				var t_Processed_E=t_E.slice(0,t_Time_First);
				var t_Time_Second=t_E.indexOf("]",0);
				if(t_Time_Second!=-1){
					var t_FTime=parseInt((t_E.slice(t_Time_First+1,t_Time_Second)),10);
					if(t_FTime!=0){
						bb_virtualos___OS_SetFileTime(RealPath(t_Processed_E),t_FTime);
					}
				}
				t_E=t_Processed_E;
			}
			if(t_IsFileDescriptor){
				__os_downloadFile(__os_storage,RealPath(t_E));
			}else{
				CreateDir(t_E);
			}
		}
...
function bb_virtualos___OS_AddFileSystem(t_URL){
	var t_FileData=__os_download(t_URL);
	var t_SS=c_StringStream.m_new.call(new c_StringStream,t_FileData,"utf8",false,c_StringStream.m_Default_Size,0,true);
...
function bb_virtualos_SetEnv(t_name,t_value){
	bb_virtualos___OS_Env.p_Set2(t_name,t_value);
	return;
}
function bb_transcc_StripQuotes(t_str){
	if(t_str.length>=2 && string_startswith(t_str,"\"") && string_endswith(t_str,"\"")){
		return t_str.slice(1,-1);
	}
	return t_str;
}
function bb_transcc_Die(t_msg){
	print("TRANS FAILED: "+t_msg);
	ExitApp(-1);
	return 0;
}
function c_Type(){
...
c_Decl.prototype.p_CheckAccess=function(){
	...
	if((t_mdecl)!=null){
		...
		if(((t_mdecl2)!=null) && t_mdecl.m_friends.p_Contains2(t_mdecl2.m_rmodpath)){
			return 1;
		}
	}
...
function c_ScopeDecl(){
	...
	this.m_declsMap=c_StringMap5.m_new.call(new c_StringMap5);
...
function c_ConfigScope(){
	...
	this.m_cdecls=c_StringMap3.m_new.call(new c_StringMap3);
	this.m_vars=c_StringMap2.m_new.call(new c_StringMap2);
}
...
c_ConfigScope.prototype.p_FindValDecl=function(t_ident){
	if(this.m_cdecls.p_Contains2(t_ident)){
...
function bb_config_SetConfigVar(t_key,t_val,t_type){
	...
	if((t_decl)!=null){
		...
		bb_config__cfgScope.m_cdecls.p_Set3(t_key,t_decl);
	}
...
function bb_transcc_ReplaceEnv(t_str){
	...
	do{
		...
		if(t_i>=2 && t_str.slice(t_i-2,t_i)=="//"){
			t_bits.p_Push4(t_str.slice(0,t_e+1));
		...
		t_bits.p_Push4(t_str.slice(0,t_i));
		t_bits.p_Push4(t_v);
		t_str=t_str.slice(t_e+1);
	}while(!(false));
	if(t_bits.p_IsEmpty()){
...
function c_Builder(){
	...
	this.m_dataFiles=c_StringMap2.m_new.call(new c_StringMap2);
}
c_Builder.m_new=function(t_tcc){
	this.m_tcc=t_tcc;
	return this;
}
...
c_Builder.prototype.p_Make=function(){
	var t_1=this.m_tcc.m_opt_config;
	if(t_1=="" || t_1=="debug"){
		this.m_tcc.m_opt_config="debug";
		this.m_casedConfig="Debug";
	}else{
		if(t_1=="release"){
			this.m_casedConfig="Release";
		}else{
			bb_transcc_Die("Invalid config");
		}
	}
	if(FileType(this.m_tcc.m_opt_srcpath)!=1){
		bb_transcc_Die("Invalid source file");
	}
	this.m_tcc.m_opt_srcpath=RealPath(this.m_tcc.m_opt_srcpath);
	if(!((this.m_tcc.m_opt_modpath).length!=0)){
		this.m_tcc.m_opt_modpath=this.m_tcc.m_monkeydir+"/modules";
	}
	this.m_tcc.m_opt_modpath=".;"+bb_virtualos_ExtractDir(this.m_tcc.m_opt_srcpath)+";"+this.m_tcc.m_opt_modpath+";"+this.m_tcc.m_monkeydir+"/targets/"+this.m_tcc.m_target.m_dir+"/modules";
	if(!this.m_tcc.m_opt_check){
		this.m_tcc.m_opt_check=true;
		this.m_tcc.m_opt_update=true;
		this.m_tcc.m_opt_build=true;
	}
	bb_config_ENV_HOST=HostOS();
	bb_config_ENV_CONFIG=this.m_tcc.m_opt_config;
	bb_config_ENV_SAFEMODE=((this.m_tcc.m_opt_safe)?1:0);
	bb_config_ENV_MODPATH=this.m_tcc.m_opt_modpath;
	bb_config_ENV_TARGET=this.m_tcc.m_target.m_system;
	this.p_Begin();
	if(!this.m_tcc.m_opt_check){
		return;
	}
	...
	this.m_app=bb_parser_ParseApp(this.m_tcc.m_opt_srcpath);
	print("Semanting...");
	...
	while(t_.p_HasNext()){
		...
		if(bb_virtualos_ExtractExt(t_file).toLowerCase()==bb_config_ENV_LANG){
			t_transbuf.p_Push4(LoadString(t_file));
			t_transbuf.p_Push4("\n");
		}
	}
	t_transbuf.p_Push4(bb_translator__trans.p_TransApp(this.m_app));
	if(!this.m_tcc.m_opt_update){
		return;
	}
	print("Building...");
	this.m_transCode=t_transbuf.p_Join("");
	var t_buildPath="";
	if((this.m_tcc.m_opt_builddir).length!=0){
		t_buildPath=bb_virtualos_ExtractDir(this.m_tcc.m_opt_srcpath)+"/"+this.m_tcc.m_opt_builddir;
	}else{
		t_buildPath=bb_virtualos_StripExt(this.m_tcc.m_opt_srcpath)+".build"+this.m_tcc.p_GetReleaseVersion();
	}
	var t_targetPath=t_buildPath+"/"+this.m_tcc.m_target.m_dir;
	if(this.m_tcc.m_opt_clean){
		bb_virtualos_DeleteDir(t_targetPath,true);
		if(FileType(t_targetPath)!=0){
			bb_transcc_Die("Failed to clean target dir");
		}
	}
	if(FileType(t_targetPath)==0){
		...
		if(FileType(t_buildPath)!=2){
			bb_transcc_Die("Failed to create build dir: "+t_buildPath);
		}
		print("A: "+this.m_tcc.m_monkeydir+"/targets/"+this.m_tcc.m_target.m_dir+"/template");
		print("B: "+t_targetPath);
		if(!bb_virtualos_CopyDir(this.m_tcc.m_monkeydir+"/targets/"+this.m_tcc.m_target.m_dir+"/template",t_targetPath,true,false)){
			bb_transcc_Die("Failed to copy target dir");
		}
	}
	if(FileType(t_targetPath)!=2){
		bb_transcc_Die("Failed to create target dir: "+t_targetPath);
	}
...
c_Builder.prototype.p_CCopyFile=function(t_src,t_dst){
	if(bb_virtualos_FileTime(t_src)>bb_virtualos_FileTime(t_dst) || FileSize(t_src)!=FileSize(t_dst)){
		bb_virtualos_DeleteFile(t_dst);
		bb_virtualos_CopyFile(t_src,t_dst);
	}
}
c_Builder.prototype.p_CreateDataDir=function(t_dir){
	t_dir=RealPath(t_dir);
	if(!this.m_syncData){
		bb_virtualos_DeleteDir(t_dir,true);
	}
	CreateDir(t_dir);
	if(FileType(t_dir)!=2){
		bb_transcc_Die("Failed to create target project data dir: "+t_dir);
	}
	var t_dataPath=bb_virtualos_StripExt(this.m_tcc.m_opt_srcpath)+".data";
	...
	if((t_dataPath).length!=0){
		...
		while(!t_srcs.p_IsEmpty()){
			...
			while(t_2<t_.length){
				...
				if(t_22==1){
					if(bb_transcc_MatchPath(t_r,this.m_DATA_FILES)){
						this.p_CCopyFile(t_p,t_t);
						t_udata.p_Insert(t_t);
						this.m_dataFiles.p_Set2(t_p,t_r);
					}
				}else{
					if(t_22==2){
						CreateDir(t_t);
	...
	if((t_dataPath).length!=0){
		...
		while(!t_dsts.p_IsEmpty()){
			...
			while(t_5<t_4.length){
				...
				if(t_32==1){
					if(!t_udata.p_Contains2(t_p3)){
						bb_virtualos_DeleteFile(t_p3);
					}
				}else{
					if(t_32==2){
						if(FileType(t_t3)==2){
							...
							bb_virtualos_DeleteDir(t_p3,true);
						}
					}
				}
			}
...
c_Builder.prototype.p_Execute=function(t_cmd,t_failHard){
	return this.m_tcc.p_Execute(t_cmd,t_failHard);
}
function c_Map4(){
	Object.call(this);
	this.m_root=null;
...
c_Html5Builder.m_new=function(t_tcc){
	c_Builder.m_new.call(this,t_tcc);
	return this;
}
	...
	while(t_.p_HasNext()){
		...
		if(t_3=="png" || t_3=="jpg" || t_3=="gif"){
			...
			if(bb_jshtml5_Info_Width==0 || bb_jshtml5_Info_Height==0){
				bb_transcc_Die("Unable to load image file '"+t_src+"'.");
			}
			t_meta.p_Push4("["+t_kv.p_Value()+"];type=image/"+t_ext+";");
			t_meta.p_Push4("width="+String(bb_jshtml5_Info_Width)+";");
			t_meta.p_Push4("height="+String(bb_jshtml5_Info_Height)+";");
			t_meta.p_Push4("\\n");
		}
	}
...
c_Html5Builder.prototype.p_Config=function(){
	...
	while(t_.p_HasNext()){
		var t_kv=t_.p_NextObject();
		t_config.p_Push4("CFG_"+t_kv.p_Key()+"="+bb_config_Enquote(t_kv.p_Value(),"js")+";");
	}
...
c_Html5Builder.prototype.p_MakeTarget=function(){
	...
	t_main=bb_transcc_ReplaceBlock(t_main,"TRANSCODE",this.m_transCode,"\n//");
	t_main=bb_transcc_ReplaceBlock(t_main,"METADATA",t_meta,"\n//");
	t_main=bb_transcc_ReplaceBlock(t_main,"CONFIG",this.p_Config(),"\n//");
	SaveString(t_main,"main.js");
	if(this.m_tcc.m_opt_run){
		var t_p=RealPath("MonkeyGame.html");
		var t_t=this.m_tcc.m_HTML_PLAYER+" \""+t_p+"\"";
...
function bb_builders_Builders(t_tcc){
	var t_builders=c_StringMap4.m_new.call(new c_StringMap4);
	t_builders.p_Set4("html5",(c_Html5Builder.m_new.call(new c_Html5Builder,t_tcc)));
	return t_builders;
}
...
c_Deque.prototype.p_ToArray=function(){
	var t_data=new_string_array(this.p_Length());
	if(this.m__first<=this.m__last){
		for(var t_i=this.m__first;t_i<this.m__last;t_i=t_i+1){
			t_data[t_i-this.m__first]=this.m__data[t_i];
		}
...
function bb_config_PushConfigScope(){
	bb_config__cfgScopeStack.p_Push13(bb_config__cfgScope);
...
function c_ModuleDecl(){
	...
	this.m_filepath="";
	this.m_modpath="";
	this.m_imported=c_StringMap6.m_new.call(new c_StringMap6);
	this.m_friends=c_StringSet.m_new.call(new c_StringSet);
	this.m_pubImported=c_StringMap6.m_new.call(new c_StringMap6);
}
...
c_ModuleDecl.m_new=function(t_ident,t_attrs,t_munged,t_modpath,t_filepath,t_app){
	...
	this.m_imported.p_Set6(t_filepath,this);
...
c_ModuleDecl.prototype.p_ImportModule=function(t_modpath,t_attrs){
	...
	if(this.m_imported.p_Contains2(t_filepath)){
		return 0;
	}
	if(!((t_mdecl)!=null)){
...
c_ModuleDecl.prototype.p_GetDecl=function(t_ident){
	...
	var t_done=c_StringMap6.m_new.call(new c_StringMap6);
	...
	while(!t_todo.p_IsEmpty()){
		...
		while(t_2.p_HasNext()){
			...
			if(!t_done.p_Contains2(t_mdecl2.m_filepath)){
	...
	if(t_str=="\n"){
		...
		if((bb_config_IsSpace(t_chr))!=0){
			...
			if(t_str=="_" || ((bb_config_IsAlpha(t_chr))!=0)){
				...
				if(c_Toker.m__keywords.p_Contains2(this.m__toke.toLowerCase())){
					this.m__tokeType=3;
				}
			}else{
							...
							if(t_str=="\""){
								...
								if(t_str=="'"){
									...
									if(t_str=="["){
										...
										this.m__tokeType=8;
										if(c_Toker.m__symbols.p_Contains2(this.m__source.slice(this.m__tokePos-1,this.m__tokePos+1))){
											this.m__tokePos+=1;
										}
									}
								}
...
c_StringSet.m_new=function(){
	c_Set.m_new.call(this,(c_StringMap5.m_new.call(new c_StringMap5)));
	return this;
}
function c_Map5(){
	Object.call(this);
...
c_Parser.prototype.p_ParseArrayExpr=function(){
	this.p_Parse("[");
	var t_args=c_Stack7.m_new.call(new c_Stack7);
	do{
		t_args.p_Push19(this.p_ParseExpr());
	}while(!(!((this.p_CParse(","))!=0)));
	this.p_Parse("]");
...
c_Parser.prototype.p_ParseTryStmt=function(){
	this.p_Parse("try");
	var t_block=c_BlockDecl.m_new.call(new c_BlockDecl,(this.m__block));
	var t_catches=c_Stack10.m_new.call(new c_Stack10);
	this.p_PushBlock(t_block);
	while(this.m__toke!="end"){
		if((this.p_CParse("catch"))!=0){
			...
			var t_block2=c_BlockDecl.m_new.call(new c_BlockDecl,(this.m__block));
			t_catches.p_Push28(c_CatchStmt.m_new.call(new c_CatchStmt,t_init,t_block2));
			this.p_PopBlock();
			this.p_PushBlock(t_block2);
		}else{
			this.p_ParseStmt();
...
c_Parser.prototype.p_ParseFuncDecl=function(t_attrs){
	...
	var t_args=c_Stack9.m_new.call(new c_Stack9);
	this.p_Parse("(");
	this.p_SkipEols();
	if(this.m__toke!=")"){
		do{
			...
			t_args.p_Push25(c_ArgDecl.m_new.call(new c_ArgDecl,t_id2,0,t_ty2,t_init));
			if(this.m__toke==")"){
				break;
			}
			this.p_Parse(",");
...
c_Parser.prototype.p_ParseClassDecl=function(t_attrs){
	...
	var t_imps=c_Stack8.m_new.call(new c_Stack8);
	if((this.p_CParse("<"))!=0){
		if((t_attrs&256)!=0){
			bb_config_Err("Extern classes cannot be generic.");
		}
		do{
			t_args.p_Push4(this.p_ParseIdent());
		}while(!(!((this.p_CParse(","))!=0)));
		this.p_Parse(">");
	}
	if((this.p_CParse("extends"))!=0){
		if((this.p_CParse("null"))!=0){
			...
			if((t_attrs&4096)!=0){
				do{
					t_imps.p_Push22(this.p_ParseIdentType());
				}while(!(!((this.p_CParse(","))!=0)));
...
c_StringList.prototype.p_Equals3=function(t_lhs,t_rhs){
	return t_lhs==t_rhs;
}
function c_Node8(){
	Object.call(this);
...
c_ClassDecl.prototype.p_OnSemant=function(){
	...
	var t_implsall=c_Stack11.m_new.call(new c_Stack11);
	for(var t_i=0;t_i<this.m_impltys.length;t_i=t_i+1){
		...
		t_impls[t_i]=t_cdecl;
		t_implsall.p_Push31(t_cdecl);
		var t_=t_cdecl.m_implmentsAll;
		var t_2=0;
		while(t_2<t_.length){
			var t_tdecl=t_[t_2];
			t_2=t_2+1;
			t_implsall.p_Push31(t_tdecl);
		}
	}
...
c_List5.prototype.p_AddFirst=function(t_data){
	return c_Node11.m_new.call(new c_Node11,this.m__head.m__succ,this.m__head,t_data);
}
function c_Node11(){
	Object.call(this);
	this.m__succ=null;
...
c_Node13.prototype.p_Remove2=function(){
	this.m__succ.m__pred=this.m__pred;
	this.m__pred.m__succ=this.m__succ;
	return 0;
}
...
c_Stack10.prototype.p_Length2=function(t_newlength){
	if(t_newlength<this.m_length){
		for(var t_i=t_newlength;t_i<this.m_length;t_i=t_i+1){
...
c_Stack10.prototype.p_Length=function(){
	return this.m_length;
}
...
function bb_preprocessor_PreProcess(t_path,t_mdecl){
	...
	var t_x=LoadString(t_path);
	var t_toker=c_Toker.m_new.call(new c_Toker,t_path,t_x);
	t_toker.p_NextToke();
	print("FILE ["+t_path+"] ("+String(t_x.length)+")");
	var t_attrs=0;
	do{
		if((t_line)!=0){
			t_source.p_Push4("\n");
										...
										if(t_ty==2){
											...
											if(t_3=="=" || t_3=="+="){
												...
												if(t_5=="="){
													var t_expr=bb_preprocessor_EvalExpr(t_toker);
													var t_val=t_expr.p_Eval();
													if(!bb_config_GetConfigVars().p_Contains2(t_toke2)){
														if((object_downcast((t_expr.m_exprType),c_StringType))!=null){
...
c_Node15.prototype.p_NextNode=function(){
	var t_node=null;
	if((this.m_right)!=null){
		t_node=this.m_right;
		while((t_node.m_left)!=null){
...
c_Node15.prototype.p_Key=function(){
	return this.m_key;
}
...
function c_Reflector(){
	...
	this.m_munged=c_StringMap.m_new.call(new c_StringMap);
	this.m_modexprs=c_StringMap2.m_new.call(new c_StringMap2);
	this.m_refmods=c_StringSet.m_new.call(new c_StringSet);
	this.m_classdecls=c_Stack11.m_new.call(new c_Stack11);
	this.m_classids=c_StringMap.m_new.call(new c_StringMap);
...
c_Reflector.prototype.p_Mung=function(t_ident){
	...
	if(this.m_munged.p_Contains2(t_ident)){
		var t_n=this.m_munged.p_Get2(t_ident);
		t_n+=1;
		this.m_munged.p_Set(t_ident,t_n);
		t_ident=t_ident+String(t_n);
	}else{
		this.m_munged.p_Set(t_ident,1);
	}
	return t_ident;
}
c_Reflector.prototype.p_ValidClass=function(t_cdecl){
	...
	if(!this.m_refmods.p_Contains2(t_cdecl.p_ModuleScope().m_filepath)){
		return false;
	}
...
c_Reflector.prototype.p_DeclExpr=function(t_decl,t_path){
	...
	if((t_mdecl)!=null){
		...
		if(!((t_expr).length!=0)){
			...
			this.m_modexprs.p_Set2(t_mdecl.m_filepath,t_expr);
		}
		return t_expr;
	}
	var t_cdecl=object_downcast((t_decl),c_ClassDecl);
...
c_Reflector.prototype.p_TypeInfo=function(t_ty){
	...
	if((object_downcast((t_ty),c_ArrayType))!=null){
		...
		if(this.m_classids.p_Contains2(t_name)){
		...
		var t_id=this.m_classdecls.p_Length();
		this.m_classids.p_Set(t_name,t_id);
		this.m_classdecls.p_Push31(t_cdecl);
		return "_classes["+String(t_id)+"]";
	}
	if((object_downcast((t_ty),c_ObjectType))!=null){
		var t_name2=this.p_DeclExpr((t_ty.p_GetClass()),true);
		if(this.m_classids.p_Contains2(t_name2)){
...
c_Reflector.prototype.p_Emit3=function(t_cdecl){
	...
	while(t_3.p_HasNext()){
		...
		if((t_fdecl)!=null){
			...
			if((t_f2).length!=0){
				if(t_fdecl.p_IsCtor()){
					t_ctors.p_Push4(t_f2);
				}else{
					if(t_fdecl.p_IsMethod()){
						t_methods.p_Push4(t_f2);
					}else{
						t_functions.p_Push4(t_f2);
					}
				}
			}
			continue;
	...
	if((t_consts.p_Length())!=0){
		this.p_Emit("  _consts=new ConstInfo["+String(t_consts.p_Length())+"]");
		for(var t_i2=0;t_i2<t_consts.p_Length();t_i2=t_i2+1){
			this.p_Emit("  _consts["+String(t_i2)+"]="+t_consts.p_Get(t_i2));
		}
	}
	if((t_globals.p_Length())!=0){
		this.p_Emit("  _globals=new GlobalInfo["+String(t_globals.p_Length())+"]");
		for(var t_i3=0;t_i3<t_globals.p_Length();t_i3=t_i3+1){
			this.p_Emit("  _globals["+String(t_i3)+"]=New "+t_globals.p_Get(t_i3));
		}
	}
	if((t_fields.p_Length())!=0){
		this.p_Emit("  _fields=New FieldInfo["+String(t_fields.p_Length())+"]");
		for(var t_i4=0;t_i4<t_fields.p_Length();t_i4=t_i4+1){
			this.p_Emit("  _fields["+String(t_i4)+"]=New "+t_fields.p_Get(t_i4));
		}
	}
	if((t_methods.p_Length())!=0){
		this.p_Emit("  _methods=New MethodInfo["+String(t_methods.p_Length())+"]");
		for(var t_i5=0;t_i5<t_methods.p_Length();t_i5=t_i5+1){
			this.p_Emit("  _methods["+String(t_i5)+"]=New "+t_methods.p_Get(t_i5));
		}
	}
	if((t_functions.p_Length())!=0){
		this.p_Emit("  _functions=New FunctionInfo["+String(t_functions.p_Length())+"]");
		for(var t_i6=0;t_i6<t_functions.p_Length();t_i6=t_i6+1){
			this.p_Emit("  _functions["+String(t_i6)+"]=New "+t_functions.p_Get(t_i6));
		}
	}
	if((t_ctors.p_Length())!=0){
		this.p_Emit("  _ctors=New FunctionInfo["+String(t_ctors.p_Length())+"]");
		for(var t_i7=0;t_i7<t_ctors.p_Length();t_i7=t_i7+1){
...
c_Reflector.prototype.p_Emit4=function(t_fdecl){
	...
	for(var t_i2=0;t_i2<t_fdecl.m_argDecls.length;t_i2=t_i2+1){
		...
		t_args.p_Push4(this.p_Unbox(t_arg2.m_type,"p["+String(t_i2)+"]"));
	}
	if(t_fdecl.p_IsCtor()){
...
c_Reflector.prototype.p_Semant3=function(t_app){
	...
	while(t_2.p_HasNext()){
		...
		this.m_modexprs.p_Set2(t_mdecl2.m_filepath,t_expr);
	...
	do{
		...
		while(t_3.p_HasNext()){
			...
			if(!this.m_refmods.p_Contains2(t_mdecl3.m_filepath)){
				continue;
			}
	...
	while(t_4.p_HasNext()){
		...
		if(!this.m_refmods.p_Contains2(t_decl.p_ModuleScope().m_filepath)){
			continue;
		}
		var t_cdecl=object_downcast((t_decl),c_ClassDecl);
		if(((t_cdecl)!=null) && this.p_ValidClass(t_cdecl)){
			this.m_classids.p_Set(this.p_DeclExpr((t_cdecl),true),this.m_classdecls.p_Length());
			this.m_classdecls.p_Push31(t_cdecl);
			continue;
		}
	}
	...
	while(t_5.p_HasNext()){
		...
		if(!this.m_refmods.p_Contains2(t_decl2.p_ModuleScope().m_filepath)){
			continue;
		}
	...
	for(var t_i=0;t_i<this.m_classdecls.p_Length();t_i=t_i+1){
		t_classes.p_Push4(this.p_Emit3(this.m_classdecls.p_Get(t_i)));
	}
	this.p_Emit("Global _init:=__init()");
	this.p_Emit("Function __init()");
	if((t_classes.p_Length())!=0){
		this.p_Emit(" _classes=New ClassInfo["+String(t_classes.p_Length())+"]");
		for(var t_i2=0;t_i2<t_classes.p_Length();t_i2=t_i2+1){
			this.p_Emit(" _classes["+String(t_i2)+"]=New "+t_classes.p_Get(t_i2));
		}
		for(var t_i3=0;t_i3<t_classes.p_Length();t_i3=t_i3+1){
			this.p_Emit(" _classes["+String(t_i3)+"].Init()");
		}
	}
	if((t_consts.p_Length())!=0){
		this.p_Emit(" _consts=new ConstInfo["+String(t_consts.p_Length())+"]");
		for(var t_i4=0;t_i4<t_consts.p_Length();t_i4=t_i4+1){
			this.p_Emit(" _consts["+String(t_i4)+"]="+t_consts.p_Get(t_i4));
		}
	}
	if((t_globals.p_Length())!=0){
		this.p_Emit(" _globals=New GlobalInfo["+String(t_globals.p_Length())+"]");
		for(var t_i5=0;t_i5<t_globals.p_Length();t_i5=t_i5+1){
	...
	for(var t_i7=t_classes.p_Length()-1;t_i7>=0;t_i7=t_i7+-1){
...
c_Stack11.prototype.p_Length2=function(t_newlength){
	if(t_newlength<this.m_length){
		for(var t_i=t_newlength;t_i<this.m_length;t_i=t_i+1){
...
c_Stack11.prototype.p_Length=function(){
	return this.m_length;
}
...
function bb_virtualos___OS_RemoveFileTime(t_RealPath){
	bb_virtualos___OS_FileTimes.p_Remove(t_RealPath);
	return;
}
function bb_virtualos_DeleteFile(t_Path){
	var t_Result=DeleteFile(t_Path);
	if(t_Result){
		bb_virtualos___OS_RemoveFileTime(RealPath(t_Path));
	}
	return t_Result;
}
function bb_virtualos_DeleteDir(t_Path,t_Recursive){
	if(!t_Recursive){
		return DeleteDir(t_Path);
	}
	var t_4=FileType(t_Path);
	if(t_4==0){
		return true;
	}else{
		if(t_4==1){
	...
	while(t_2<t_.length){
		...
		var t_FPath=t_Path+"/"+t_F;
		if(FileType(t_FPath)==2){
			if(!bb_virtualos_DeleteDir(t_FPath,true)){
				return false;
			}
		}else{
			if(!bb_virtualos_DeleteFile(t_FPath)){
				return false;
			}
		}
	}
...
function bb_virtualos_FileTime(t_Path){
	return bb_virtualos___OS_FileTimes.p_Get2(RealPath(t_Path));
}
function bb_virtualos_CopyFile(t_Src,t_Dst){
	var t_Result=CopyFile(t_Src,t_Dst);
	if(t_Result){
		bb_virtualos___OS_SetFileTime(RealPath(t_Dst),bb_virtualos_FileTime(t_Src));
	}
	return t_Result;
}
function bb_virtualos_CopyDir(t_SourcePath,t_DestinationPath,t_Recursive,t_Hidden){
	...
	while(t_3<t_.length){
		...
		if(t_32==1){
			if(!bb_virtualos_CopyFile(t_SrcP,t_DstP)){
				return false;
			}
		}else{
			if(t_32==2){
...
function bbMain(){
	var t_tcc=c_TransCC.m_new.call(new c_TransCC);
	var t_Real=RealPath("data/transcc_here.txt");
	var t_Remote=__os_toRemotePath(t_Real);
	var t_X=__os_fixDir("data/bin/../modules/monkey/monkey.monkey");
	bb_virtualos___OS_AddFileSystem(t_Remote);
	t_tcc.p_Run(AppArgs());
	return 0;
}
...
function bb_util_ResizeBuffer(t_Buffer,t_Size,t_CopyData,t_DiscardOldBuffer,t_OnlyWhenDifferentSizes){
	var t_BufferAvailable=t_Buffer!=null;
	if(t_BufferAvailable && t_OnlyWhenDifferentSizes){
		if(t_Size!=-1 && t_Buffer.Length()==t_Size){
			return t_Buffer;
		}
	}
	if(t_Size==-1){
		t_Size=t_Buffer.Length();
	}
	var t_B=c_DataBuffer.m_new.call(new c_DataBuffer,t_Size,false);
	if(t_BufferAvailable){
		if(t_CopyData){
			t_Buffer.p_CopyBytes(0,t_B,0,t_Buffer.Length());
		}
		if(t_DiscardOldBuffer){
			t_Buffer.Discard();
		}
	}
	return t_B;
...
c_CTranslator.prototype.p_MungMethodDecl=function(t_fdecl){
	...
	if(this.m_mungedFuncs.p_Contains2(t_id)){
		var t_n=1;
		do{
			t_n+=1;
			t_id=t_fdecl.m_ident+String(t_n);
		}while(!(!this.m_mungedFuncs.p_Contains2(t_id)));
	}
...
c_CTranslator.prototype.p_MungDecl=function(t_decl){
	...
	if((t_set)!=null){
		if(t_set.p_Contains2(t_munged.toLowerCase())){
			var t_id2=1;
			do{
				t_id2+=1;
				var t_t=t_munged+String(t_id2);
				if(t_set.p_Contains2(t_t.toLowerCase())){
					continue;
				}
				t_munged=t_t;
				break;
...
c_CTranslator.prototype.p_Emit=function(t_t){
	...
	this.m_lines.p_Push4(this.m_indent+t_t);
...
function bb_transcc_MatchPathAlt(t_text,t_alt){
	if(!(t_alt.indexOf("*")!=-1)){
		return t_alt==t_text;
	}
	var t_bits=t_alt.split("*");
...
function bb_transcc_MatchPath(t_text,t_pattern){
	t_text="/"+t_text;
	var t_alts=t_pattern.split("|");
	var t_match=false;
	var t_=t_alts;
...
c_DataStream.prototype.p_Write=function(t_buf,t_offset,t_count){
	if(this.m__position+t_count>this.m__length){
		t_count=this.m__length-this.m__position;
	}
	t_buf.p_CopyBytes(t_offset,this.m__buffer,this.m__offset+this.m__position,t_count);
	this.m__position+=t_count;
	return t_count;
}
...
function bb_transcc_ReplaceBlock(t_text,t_tag,t_repText,t_mark){
	var t_beginTag=t_mark+"${"+t_tag+"_BEGIN}";
	var t_i=t_text.indexOf(t_beginTag,0);
	if(t_i==-1){
		bb_transcc_Die("Error updating target project - can't find block begin tag '"+t_tag+"'. You may need to delete target .build directory.");
	}
	...
	if(t_i2==-1){
		bb_transcc_Die("Error updating target project - can't find block end tag '"+t_tag+"'.");
	}
...
c_Node16.prototype.p_Remove2=function(){
	this.m__succ.m__pred=this.m__pred;
	this.m__pred.m__succ=this.m__succ;
	return 0;
}
...
c_Map9.prototype.p_Contains2=function(t_key){
	return this.p_FindNode(t_key)!=null;
}
...
function bbInit(){
	c_StringStream.m_Default_Size=1024;
	bb_asyncevent__sources=c_Stack.m_new.call(new c_Stack);
	c_Stack3.m_NIL=null;
	c_Stack2.m_NIL="";
	c_Stream.m__tmp=c_DataBuffer.m_new.call(new c_DataBuffer,4096,false);
	bb_virtualos___OS_FileTimes=c_StringMap.m_new.call(new c_StringMap);
	bb_virtualos___OS_Env=c_StringMap2.m_new.call(new c_StringMap2);
	c_Type.m_stringType=c_StringType.m_new.call(new c_StringType);
	bb_config__errInfo="";
	bb_config__cfgScope=c_ConfigScope.m_new.call(new c_ConfigScope);
	c_Deque.m_NIL="";
	bb_config__cfgScopeStack=c_Stack5.m_new.call(new c_Stack5);
	bb_decl__env=null;
